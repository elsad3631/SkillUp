<template>
  <div
    class="modal fade"
    id="kt_modal_upload_employee_file"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_upload_employee_file_header">
          <!--begin::Modal title-->
          ...
          <!--begin::Close-->
          <div
            id="kt_modal_upload_employee_file_close"
        ...
        <div class="modal-body py-10 px-lg-17">
          ...
          <div
            ...
            id="kt_modal_upload_employee_file_scroll"
            data-kt-scroll="true"
            data-kt-scroll-activate="{default: false, lg: true}"
            data-kt-scroll-max-height="auto"
            data-kt-scroll-dependencies="#kt_modal_upload_employee_file_header"
            data-kt-scroll-wrappers="#kt_modal_upload_employee_file_scroll"
  ...
  setup(props, { emit }) {
    ...
    const handleUpload = async () => {
      ...
      try {
        ...
        // Close modal
        const modal = document.getElementById('kt_modal_upload_employee_file');
        if (modal) {
