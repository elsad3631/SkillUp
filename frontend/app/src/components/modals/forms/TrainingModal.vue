  ...
  >
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <div class="modal-content">
        <div class="modal-header" id="kt_modal_training_header">
          <h2 class="fw-bold">{{ isEditing ? 'Edit Training' : 'New Training' }}</h2>
          <div
            id="kt_modal_training_close"
        ...
        >
          <div class="modal-body py-10 px-lg-17">
            <div
              ...
              id="kt_modal_training_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_training_header"
              data-kt-scroll-wrappers="#kt_modal_training_scroll"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const trainingModalRef = ref<null | HTMLElement>(null);
