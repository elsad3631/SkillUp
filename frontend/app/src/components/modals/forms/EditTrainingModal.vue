  ...
  >
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <div class="modal-content">
        <div class="modal-header" id="kt_modal_edit_training_header">
          <h2 class="fw-bold">Edit Training</h2>
          <div
            id="kt_modal_edit_training_close"
        ...
        >
          <div class="modal-body py-10 px-lg-17">
            <div
              ...
              id="kt_modal_edit_training_scroll"
              data-kt-scroll="true"
              data-kt-scroll-activate="{default: false, lg: true}"
              data-kt-scroll-max-height="auto"
              data-kt-scroll-dependencies="#kt_modal_edit_training_header"
              data-kt-scroll-wrappers="#kt_modal_edit_training_scroll"
...
import type { Training } from "@/core/services/businessServices/Training";
...
export default defineComponent({
  name: "edit-training-modal",
  components: {
    KTIcon,
  },
  props: {
    training: {
      type: Object as () => Training | null,
      default: null,
    },
    loading: {
      type: Boolean,
  ...
  setup(props, { emit }) {
    ...
    const editTrainingModalRef = ref<null | HTMLElement>(null);
    const skillsInput = ref("");

    const formData = ref<EditTrainingFormData>({
      title: "",
      description: "",
      provider: "",
      url: "",
    ...
    // Load training data when modal is shown
    watch(() => [props.show, props.training], ([newShow, newTraining]) => {
      if (newShow && newTraining && typeof newTraining === 'object') {
        formData.value = {
          title: newTraining.title || "",
          description: newTraining.description || "",
          provider: newTraining.provider || "",
          url: newTraining.url || "",
          estimatedDurationHours: newTraining.estimatedDurationHours || 1,
          skillsDeveloped: [...(newTraining.skillsDeveloped || [])],
