<template>
  <div
    class="modal fade"
    id="kt_modal_create_employee_folder"
    tabindex="-1"
    aria-hidden="true"
  ...
  >
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        <!--begin::Modal header-->
        <div class="modal-header" id="kt_modal_create_employee_folder_header">
          <!--begin::Modal title-->
          ...
          <!--begin::Close-->
          <div
            id="kt_modal_create_employee_folder_close"
        ...
        <div class="modal-body py-10 px-lg-17">
          ...
          <div
            ...
            id="kt_modal_create_employee_folder_scroll"
            data-kt-scroll="true"
            data-kt-scroll-activate="{default: false, lg: true}"
            data-kt-scroll-max-height="auto"
            data-kt-scroll-dependencies="#kt_modal_create_employee_folder_header"
            data-kt-scroll-wrappers="#kt_modal_create_employee_folder_scroll"
...
export default defineComponent({
  name: "CreateEmployeeFolderModal",
  components: {
    KTIcon,
  },
  props: {
  ...
  setup(props, { emit }) {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        // Close modal
        const modal = document.getElementById('kt_modal_create_employee_folder');
        if (modal) {
